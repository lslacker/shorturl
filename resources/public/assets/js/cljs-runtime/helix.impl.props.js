...
return name_str.replace(helix.impl.props.camel_regexp,(function (p1__28068_SHARP_,p2__28067_SHARP_){
return p2__28067_SHARP_.toUpperCase();
}));
...
var G__28081 = o;
helix.impl.props.goog$module$goog$object.set(G__28081,k,v);
...
while(true){
if(cljs.core.seq(m)){
var G__28095 = cljs.core.rest(m);
var G__28096 = (function (){var entry = cljs.core.first(m);
...
return helix.impl.props.into_js_array(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28085_SHARP_){
if(cljs.core.map_QMARK_(p1__28085_SHARP_)){
return helix.impl.props.primitive_obj.cljs$core$IFn$_invoke$arity$1(p1__28085_SHARP_);
} else {
return p1__28085_SHARP_;
}
}),style));
} else {
return style;
...
while(true){
if(cljs.core.seq(m)){
var G__28118 = cljs.core.rest(m);
var G__28119 = (function (){var entry = cljs.core.first(m);
