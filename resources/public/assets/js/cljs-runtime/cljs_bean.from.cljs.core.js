...
var G__27723 = cljs.core.next(xs);
var G__27724 = cljs.core.next(ys);
xs = G__27723;
ys = G__27724;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27692 = val;
var G__27693 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27692,G__27693) : f.call(null,G__27692,G__27693));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27694 = val__$1;
var G__27695 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27694,G__27695) : f.call(null,G__27694,G__27695));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__27696 = val__$1;
var G__27697 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__27696,G__27697) : f.call(null,G__27696,G__27697));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__27732 = cljs.core.next(es);
var G__27733 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__27732;
tcoll__$1 = G__27733;
continue;
} else {
...
var G__27734 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__27735 = cljs.core.next(es);
ret = G__27734;
es = G__27735;
continue;
} else {
