...
var i_30014 = (self__.level + (1));
while(true){
if((i_30014 <= (new_level + (1)))){
(update[i_30014] = self__.header);

var G__30016 = (i_30014 + (1));
i_30014 = G__30016;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_30017 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30017[i]));
} else {
x__$2.forward.push((((i < links_30017.length))?(links_30017[i]):null));
}

if((i < links_30017.length)){
(links_30017[i] = x__$2);
} else {
links_30017.push(x__$2);
}
...
var i_30023 = (0);
while(true){
if((i_30023 <= self__.level)){
var links_30024 = (update[i_30023]).forward;
if((x__$1 === (((i_30023 < links_30024.length))?(links_30024[i_30023]):null))){
(links_30024[i_30023] = (x__$1.forward[i_30023]));

var G__30025 = (i_30023 + (1));
i_30023 = G__30025;
continue;
} else {
var G__30026 = (i_30023 + (1));
i_30023 = G__30026;
continue;
}
} else {
