...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__29585){
...
var vec__29590 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29590,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29590,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29590,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_29675 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_29675(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_29686 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_29686(a,b);
}
});
...
var fexpr__29643 = (function (){var G__29644 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__29644__$1)].join('')));

}
})();
return (fexpr__29643.cljs$core$IFn$_invoke$arity$2 ? fexpr__29643.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__29643.call(null,a,b));
}));
/**
